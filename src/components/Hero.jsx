  ...
  return (
    <section className="relative bg-[url('/images/skate.jpg')] bg-cover bg-center min-h-screen">
      ...
      <div className="relative z-10 flex  items-center justify-center h-full">
        <div className="flex flex-col hero-title-line gap-4 text-center text-6xl  mt-40">
          ...
          <div className="flex gap-10 mx-auto">
            <button className="text-black cursor-pointer text-xl font-bold bg-[#39FF14] w-40 p-2 rounded shadow-md shadow-black">
              Get Tickets
            </button>
